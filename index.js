...
const questions = [
  {
    question: "Qual das seguintes tags HTML é usada para criar uma lista não ordenada?",
    answers: [
  ...
  {
    question: "Em JavaScript, qual comando é usado para exibir uma mensagem de alerta em uma caixa de diálogo no navegador?",
    answers: [
